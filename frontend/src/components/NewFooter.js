    ...
    <footer className="bg-black text-white">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/visit" className="text-gray-400 hover:text-white transition-colors">
                  Visit POA
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/giving" className="text-gray-400 hover:text-white transition-colors">
                  Give
                </Link>
              </li>
              <li>
                <Link to="/about/story" className="text-gray-400 hover:text-white transition-colors">
                  Story
                </Link>
              </li>
              <li>
                <Link to="/about/pastors" className="text-gray-400 hover:text-white transition-colors">
                  Meet Our Pastors
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/students" className="text-gray-400 hover:text-white transition-colors">
                  Refuge Student Ministries
                </Link>
              </li>
              <li>
                <Link to="/ministries/discover" className="text-gray-400 hover:text-white transition-colors">
                  Ministries Discover POA
                </Link>
              </li>
              <li>
                <Link to="/prayer" className="text-gray-400 hover:text-white transition-colors">
                  Prayer Request
                </Link>
              </li>
              <li>
                <Link to="/ministries/adults" className="text-gray-400 hover:text-white transition-colors">
                  Adult Ministries
                </Link>
              </li>
              <li>
                <Link to="/ministries/restoration" className="text-gray-400 hover:text-white transition-colors">
                  Restoration
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between text-sm text-gray-400">
          <p>© 2025 The Pentecostals of Alexandria. All rights reserved.</p>
